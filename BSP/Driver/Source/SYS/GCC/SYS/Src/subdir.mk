...
Src/wb_aic.o: F:/ARM_Project/W55FA92/N9H20/BSP/Driver/Source/SYS/wb_aic.c
	...
	arm-none-eabi-gcc -mcpu=arm926ej-s -marm -mlittle-endian -mfloat-abi=soft -Os -fmessage-length=0 -fsigned-char -ffunction-sections -fdata-sections  -g -I"F:/ARM_Project/W55FA92/N9H20/BSP/Driver/Source/SYS/GCC/../../../Include" -std=c99 -Wa,-adhlns="$@.lst" -MMD -MP -MF"$(@:%.o=%.d)" -MT"$(@)" -c -o "$@" "$<"
