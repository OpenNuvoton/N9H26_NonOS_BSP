...
/* Timer Registers */
//#define TMR_BA		N9H26K_VA_TIMER	/* Timer */
...
#define REG_LCM_MPUCMD 			(VPOST_BA+0x20)		// R/W: MPU-type LCD Command Register
	...
	#define MPUCMD_MPU68			BIT23				// MPU interface selection, reserved in N9H26K
...
#define REG_LCM_TVCtl			(VPOST_BA+0x40)		// R/W: TvControl Register
	...
	#define TVCtl_TvCMM 			BIT16				// TV Color Modulation Method, reserved in N9H26K
															//   1 = 27 MHz, 0 = 13.5 MHz

	#define TVCtl_TV_D1 			BIT15				// TV D1 size
	#define TVCtl_FBSIZE 			NVTBIT(15,14)		// Frame Buffer Size in Tv NonInterlance Mode; these two bits are removed in N9H2
															//	00 = 320x240 (QVGA)
															//  01 = 640x240 (HVGA)
...
//#define JPEG_BASE	N9H26K_VA_JPEG		/* Jpeg Control */
...
//#define AIC_BA		N9H26K_VA_IRQ		/* Interrupt Controller */
...
//#define GPIO_BA		N9H26K_VA_GPIO		/* GPIO Control */
...
//#define PA_VA_USB_BASE	N9H26K_VA_USBD
...
//#define I2C_BASE	N9H26K_VA_I2C	/* I2CH Control */
...
//#define SPI_BASE_0	(N9H26K_VA_SPI0)
...
//#define SPI_BASE_1	(N9H26K_VA_SPI1)
